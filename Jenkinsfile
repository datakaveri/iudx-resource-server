    ...
    stage('Run Jmeter Performance Tests'){
      steps{
        script{
          ...
          sh 'sleep 45'
          sh 'authtoken=$(sh /var/lib/jenkins/iudx/rs/generateToken.sh)'
          sh 'rm -rf Jmeter/report ; mkdir -p Jmeter/report ; /var/lib/jenkins/apache-jmeter-5.4.1/bin/jmeter.sh -n -t Jmeter/ResourceServer.jmx -l Jmeter/report/JmeterTest.jtl -e -o Jmeter/report/ -Jtoken=$authtoken'
