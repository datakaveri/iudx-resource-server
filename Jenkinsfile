      ...
      steps{
        node('master') {
          script{
            ...
            sh "/var/lib/jenkins/apache-jmeter-5.4.1/bin/jmeter.sh -n -t /var/lib/jenkins/iudx/rs/Jmeter/ResourceServer.jmx -l /var/lib/jenkins/iudx/rs/Jmeter/report/JmeterTest.jtl -e -o /var/lib/jenkins/iudx/rs/Jmeter/report/ -JpuneToken=$env.puneToken -JsuratToken=$env.suratToken"
          }
        }
      }
    }
