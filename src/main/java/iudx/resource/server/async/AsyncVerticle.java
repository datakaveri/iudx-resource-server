 ...
 * <p>
 *   The Async Verticle implementation in the IUDX Resource Server exposes the
 *   {@link iudx.resource.server.async.AsyncService} over the Vert.x Event Bus.
 * </p>
 *
 * @version 1.0
 * @since 2022-02-08
...
public class AsyncVerticle extends AbstractVerticle {
	...
	public void start() throws Exception {
		...
		consumer =
				...
				.register(AsyncService.class, asyncService);
	}
