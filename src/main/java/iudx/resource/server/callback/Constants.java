...
public class Constants {
  ...
  public static final String CONNECT_TO_CALLBACK_NOTIFICATION_QUEUE =
      "Connected to callback.notification queue";
  public static final String CONNECT_TO_CALLBACK_NOTIFICATION_QUEUE_FAIL =
      "Failed to connect with callback.notification queue";

  public static final String CONNECT_TO_CALLBACK_DATA_QUEUE = "Connected to callback.data queue";
  public static final String CONNECT_TO_CALLBACK_DATA_QUEUE_FAIL =
      "Failed to connect with callback.data queue";
  ...
  public static final String QUEUE_CONNECTION_FAIL =
      "rabbitmq client failed to create connection with Queue";
  ...
  public static final String DATABASE_OPERATION_INVALID =
      "Invalid database operation. Operation should be one of [create or update or delete]";
  public static final String DATABASE_OPERATION_NOT_FOUND =
      "Database operation not found in message body";
  ...
  public static final String CREATE_CALLBACK_REQUEST_OBJECT_FAIL =
      "Failed to create request object for sending callback request";
  public static final String CONNECT_TO_CALLBACK_URL_FAIL = "Failed to connect callbackUrl";
  public static final String NO_CALLBACK_URL_FOR_ROUTING_KEY =
      "No callBackUrl exist for routing key";
}
