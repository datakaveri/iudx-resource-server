...
public class ElasticClient {
	 ...
	 */
	public ElasticClient searchAsync(String index, String query, Handler<AsyncResult<JsonArray>> searchHandler) {
	 ...
	 */
	public ElasticClient countAsync(String index, String query, Handler<AsyncResult<JsonObject>> countHandler) {
