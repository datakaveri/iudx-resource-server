...
(
   _id varchar NOT NULL, -- subscription id
...
CREATE TRIGGER update_sub_modified BEFORE INSERT OR UPDATE ON subscriptions FOR EACH ROW EXECUTE PROCEDURE update_modified ();
