...
public class ManagementApiImplTest {
    ...
    public void testCreateExchangeSuccess(VertxTestContext vertxTestContext)
    {
        ...
        }).when(dataBrokerService).createExchange(any(),any(),any());
        managementApi.createExchange(json,dataBrokerService).onComplete(handler -> {
    ...
    public void testDeleteExchangeSuccess(VertxTestContext vertxTestContext)
    {
        ...
        }).when(dataBrokerService).deleteExchange(any(),anyString(),any());

        managementApi.deleteExchange(exchangeID,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
    ...
    public void testGetExchangeDetailsSuccess(VertxTestContext vertxTestContext)
    {
        ...
        }).when(dataBrokerService).listExchangeSubscribers(any(),anyString(),any());

        managementApi.getExchangeDetails(exchangeID,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
    ...
    public void testCreateQueueSuccess(VertxTestContext vertxTestContext)
    {
        ...
        }).when(dataBrokerService).createQueue(any(),anyString(),any());

        managementApi.createQueue(json,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
    ...
    public void testDeleteQueueSuccess(VertxTestContext vertxTestContext)
    {
        ...
        }).when(dataBrokerService).deleteQueue(any(),anyString(),any());

        managementApi.deleteQueue(queueID,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
    ...
    public void testGetQueueDetailsSuccess(VertxTestContext vertxTestContext)
    {
        ...
        }).when(dataBrokerService).listQueueSubscribers(any(),anyString(),any());

        managementApi.getQueueDetails(queueID,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
    ...
    public void testBindQueue2ExchangeSuccess(VertxTestContext vertxTestContext)
    {
        ...
        }).when(dataBrokerService).bindQueue(any(),anyString(),any());

        managementApi.bindQueue2Exchange(json,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
    ...
    public void testUnbindQueue2ExchangeSuccess(VertxTestContext vertxTestContext)
    {
        ...
        }).when(dataBrokerService).unbindQueue(any(),anyString(),any());

        managementApi.unbindQueue2Exchange(json,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
    ...
    public void testPublishDownstreamIssuesSuccess(VertxTestContext vertxTestContext)
    {
        ...
        managementApi.publishDownstreamIssues(json,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
    ...
    public void testPublishDataIssueSuccess(VertxTestContext vertxTestContext)
    {
        ...
        managementApi.publishDataIssue(json,dataBrokerService).onComplete(handler -> {
            if(handler.succeeded())
            {
                assertEquals(json,handler.result());
                vertxTestContext.completeNow();
