...
public class NGSILDQueryParamsTest {
  ...
  public void test_create_with_json_input(String distance, VertxTestContext vertxTestContext)
    ...
    assertEquals(
        "TemporalRelation [endTime=Dummy endtime value, temprel=Dummy timerel value, time=Dummy"
            + " time value]",
