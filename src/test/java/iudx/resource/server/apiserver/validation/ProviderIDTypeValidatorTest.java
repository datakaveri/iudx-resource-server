...
import iudx.resource.server.apiserver.validation.types.ProviderIDTypeValidator;
...
public class ProviderIDTypeValidatorTest {
  ...
  private ProviderIDTypeValidator idTypeValidator;
  ...
  public void testValidIDTypeValue(String value, boolean required, Vertx vertx,
    ...
    idTypeValidator = new ProviderIDTypeValidator(value, required);
