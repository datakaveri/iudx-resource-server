...
public class DataBrokerServiceImplTest {
  ...
  public void testRegisterCallbackSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    when(DataBrokerServiceImpl.subscriptionService.registerCallbackSubscription(any()))
  ...
  public void testUpdateCallbackSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    DataBrokerServiceImpl.subscriptionService = mock(SubscriptionService.class);
    when(DataBrokerServiceImpl.subscriptionService.updateCallbackSubscription(any()))
        .thenReturn(jsonObjectFuture);
    when(asyncResult.succeeded()).thenReturn(true);
    when(asyncResult.result()).thenReturn(request);
    doAnswer(
  ...
  public void testDeleteCallbackSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    DataBrokerServiceImpl.subscriptionService = mock(SubscriptionService.class);
    when(DataBrokerServiceImpl.subscriptionService.deleteCallbackSubscription(any()))
        .thenReturn(jsonObjectFuture);
    when(asyncResult.succeeded()).thenReturn(true);
    when(asyncResult.result()).thenReturn(request);
    doAnswer(
    ...
    databroker.deleteCallbackSubscription(
        request,
        handler -> {
          if (handler.succeeded()) {
            assertEquals(request, handler.result());
  ...
  public void testListCallbackSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    DataBrokerServiceImpl.subscriptionService = mock(SubscriptionService.class);
    when(DataBrokerServiceImpl.subscriptionService.listCallbackSubscription(any()))
        .thenReturn(jsonObjectFuture);
    when(asyncResult.succeeded()).thenReturn(true);
    when(asyncResult.result()).thenReturn(request);
    doAnswer(
  ...
  public void test_updateAdaptor(VertxTestContext testContext) {
    DataBrokerService result =
        databroker.updateAdaptor(new JsonObject(), "Dummy vHost", AsyncResult::succeeded);
    assertNull(result);
  ...
  public void test_deleteStreamingSubscription_success(VertxTestContext vertxTestContext) {
    DataBrokerServiceImpl.subscriptionService = mock(SubscriptionService.class);
    when(DataBrokerServiceImpl.subscriptionService.deleteStreamingSubscription(any()))
        .thenReturn(jsonObjectFuture);
    when(asyncResult.succeeded()).thenReturn(true);
    when(asyncResult.result()).thenReturn(request);
    doAnswer(
  ...
  public void test_listStreamingSubscription_success(VertxTestContext vertxTestContext) {
    DataBrokerServiceImpl.subscriptionService = mock(SubscriptionService.class);
    when(DataBrokerServiceImpl.subscriptionService.listStreamingSubscriptions(any()))
        .thenReturn(jsonObjectFuture);
    when(asyncResult.succeeded()).thenReturn(true);
    when(asyncResult.result()).thenReturn(request);
    doAnswer(
  ...
  public void test_deleteStreamingSubscription_with_empty_request(
  ...
  public void test_deleteCallbackSubscription_with_empty_request(
      VertxTestContext vertxTestContext) {
    expected = expected_failure();
    databroker.deleteCallbackSubscription(
        new JsonObject(),
