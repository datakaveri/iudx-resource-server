...
public class SubscriptionServiceTest {
  @Mock RabbitClient rabbitClient;
  ...
  @Mock AsyncResult<RowSet<Row>> asyncResult;
  @Mock AsyncResult<JsonObject> asyncResult1;
  ...
  public void testUpdateCallbackSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    String str =
        "{\"subscriptionID\":\"consumer/cc92a0dbd4da9a5a024a5395062f6f905c7e5797/Dummy name\"}";
    ...
    doAnswer(
        ...
        .when(rabbitMQClient)
        .basicPublish(anyString(), anyString(), any(Buffer.class), any());

    service
        .updateCallbackSubscription(request)
        .onComplete(
            handler -> {
  ...
  public static Stream<Arguments> values() {
    return Stream.of(
        Arguments.of(
            ...
            "{\"type\":400,\"title\":\"error\",\"detail\":\"Binding failed\"}"),
        Arguments.of(
            "ABCD/ABCD/ABCD",
            "{\"type\":400,\"title\":\"error\",\"detail\":\"Invalid or null routing key\"}"));
  }
  ...
  public void testUpdateCallbackSubscriptionFailure(
      String inputString, String str, VertxTestContext vertxTestContext) {
    JsonArray jsonArray = new JsonArray();
    JsonObject expected = new JsonObject(str);
  ...
  public void testUpdateCallbackSubscriptionForNullRequest(VertxTestContext vertxTestContext) {
    service
        .updateCallbackSubscription(null)
        .onComplete(
            handler -> {
              if (handler.failed()) {
                assertEquals(
                    "{\"type\":400,\"title\":\"error\",\"detail\":\"Invalid request payload\"}",
  ...
  public void testAppendStreamingSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    lenient()
        .when(rabbitClient.listQueueSubscribers(any(), anyString()))
        .thenReturn(jsonObjectFuture);
    lenient().when(rabbitClient.bindQueue(any(), anyString())).thenReturn(jsonObjectFuture);
    lenient()
        .when(rabbitClient.updateUserPermissions(anyString(), anyString(), any(), anyString()))
        .thenReturn(jsonObjectFuture);
    ...
    service
        .appendStreamingSubscription(request)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                assertEquals(
                    "{\"type\":\"urn:dx:rs:success\",\"title\":\"success\",\"results\":[{\"entities\":[\"ABCD/ABCD/ABCD/ABCD/ABCD/\",\"EFGH/EFGH/EFGH/EFGH/EFGH/\"]}]}",
  ...
  public void testAppendStreamingSubscriptionWithInvalidInput(VertxTestContext vertxTestContext) {
    service
        .appendStreamingSubscription(new JsonObject())
        .onComplete(
            handler -> {
              if (handler.failed()) {
                assertEquals(
  ...
  public void testRegisterCallbackSubscriptionWithInvalidInput(VertxTestContext vertxTestContext) {
    service
        .registerCallbackSubscription(null)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                vertxTestContext.failNow(handler.cause());
  ...
  public void testDeleteCallbackSubscriptionWithInvalidInput(VertxTestContext vertxTestContext) {
    service
        .deleteCallbackSubscription(null)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                vertxTestContext.failNow(handler.cause());
  ...
  static Stream<Arguments> listCallbackInputValues() {
    return Stream.of(
        Arguments.of(
            ...
            "{\"type\":400,\"title\":\"error\",\"detail\":\"Invalid request payload\"}"),
        Arguments.of(
            SubscriptionServiceTest.request,
            "{\"type\":400,\"title\":\"error\",\"detail\":\"Invalid request payload\"}"));
  }
  ...
  public void testListCallbackSubscription(
      JsonObject input, String expected, VertxTestContext vertxTestContext) {
    ...
    lenient()
        ...
        .onComplete(any());
    service
        .listCallbackSubscription(input)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                vertxTestContext.failNow(handler.cause());
    ...
    service
        ...
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                assertEquals(
                    "{\"type\":\"urn:dx:rs:success\",\"title\":\"success\",\"results\":[{\"username\":\"Dummy_User_ID\",\"apiKey\":\"Dummy"
                        + " API KEY\",\"id\":\"Dummy_User_ID/Dummy name\",\"URL\":\"Dummy"
                        + " string\",\"port\":200,\"vHost\":\"Dummy string\"}]}",
                    handler.result().toString());
                vertxTestContext.completeNow();
  ...
  public void testUpdateStreamingSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    doAnswer(
        ...
        .onComplete(any());
    service
        .updateStreamingSubscription(request)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                assertEquals(
  ...
  public void testDeleteStreamingSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    doAnswer(
        ...
        .onComplete(any());
    service
        .deleteStreamingSubscription(request)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                assertEquals(
                    "{\"type\":\"urn:dx:rs:success\",\"status\":200,\"title\":\"success\",\"detail\":\"Subscription"
    ...
    service
        ...
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                assertEquals(
                    "{\"type\":\"urn:dx:rs:success\",\"title\":\"success\",\"results\":[{\"subscriptionID\":\"Dummy_Queue_Name\",\"userid\":\"Dummy_User_ID\",\"consumer\":\"Dummy@consumer\",\"name\":\"Dummy"
                        + " name\",\"callbackURL\":\"Dummy callbackurl\",\"queue\":\"Dummy"
                        + " Queue\",\"entities\":[\"ABCD/ABCD/ABCD/ABCD\",\"EFGH/EFGH/EFGH/EFGH\"],\"apiKey\":\"Dummy"
                        + " API KEY\"}]}",
                    handler.result().toString());
                vertxTestContext.completeNow();
  ...
  public void testRegisterCallbackSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    service
        .registerCallbackSubscription(request)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                assertEquals(
                    "{\"subscriptionID\":\"consumer/cc92a0dbd4da9a5a024a5395062f6f905c7e5797/Dummy"
                        + " name\"}",
                    handler.result().toString());
                vertxTestContext.completeNow();
  ...
  public void testDeleteCallbackSubscriptionSuccess(VertxTestContext vertxTestContext) {
    ...
    service
        .deleteCallbackSubscription(request)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                assertEquals(
  ...
  public void test_registerStreamingSubscription_userpermissionhandler_failed(
        ...
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                ...
                assertEquals(
                    "{\"type\":400,\"title\":\"Bad Request data\",\"detail\":\"Binding failed\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
              }
            });
  ...
  public void test_registerStreamingSubscription_with_resultHandlerqueue_failure(
      VertxTestContext vertxTestContext) {
    Future<JsonObject> jsonObjectFuture1 = mock(Future.class);
    AsyncResult<JsonObject> asyncResult2 = mock(AsyncResult.class);
  ...
  public void test_registerStreamingSubscription_with_null_routingkey(
      VertxTestContext vertxTestContext) {
    Future<JsonObject> jsonObjectFuture1 = mock(Future.class);
    AsyncResult<JsonObject> asyncResult2 = mock(AsyncResult.class);
    jsonArray.add(null);
  ...
  public void test_registerStreamingSubscription_with_null_request(
      VertxTestContext vertxTestContext) {

    String expected =
        "{\"type\":400,\"title\":\"Bad Request data\",\"detail\":\"Invalid request payload\"}";
    service
        .registerStreamingSubscription(null)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                vertxTestContext.failNow(handler.cause());
  ...
  public void test_registerStreamingSubscription_with_failed_queue_creation(
      VertxTestContext vertxTestContext) {
    Future<JsonObject> jsonObjectFuture1 = mock(Future.class);
    AsyncResult<JsonObject> asyncResult2 = mock(AsyncResult.class);
        ...
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                ...
                assertEquals(
                    "{\"subscriptionID\":\"Dummy_Queue_Name\",\"userid\":\"Dummy_User_ID\",\"consumer\":\"Dummy@consumer\",\"name\":\"Dummy"
                        + " name\",\"callbackURL\":\"Dummy callbackurl\",\"queue\":\"Dummy"
                        + " Queue\",\"entities\":[\"ABCD/ABCD/ABCD/ABCD\",\"EFGH/EFGH/EFGH/EFGH\"],\"apiKey\":\"Dummy"
                        + " API KEY\",\"title\":\"failure\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
              }
            });
  ...
  public void test_updateStreamingSubscription_null_request(VertxTestContext vertxTestContext) {
    service
        .updateStreamingSubscription(null)
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
  ...
  static Stream<Arguments> routingKey() {
    return Stream.of(
        Arguments.of(
            null, "{\"type\":400,\"title\":\"error\",\"detail\":\"Invalid or null routing key\"}"),
        Arguments.of(
            "", "{\"type\":400,\"title\":\"error\",\"detail\":\"Invalid or null routing key\"}"));
  }
  ...
  public void test_updateStreamingSubscription_different_routingKey(
      String value, String expected, VertxTestContext vertxTestContext) {
    Future<JsonObject> jsonObjectFuture1 = mock(Future.class);
    AsyncResult<JsonObject> asyncResult2 = mock(AsyncResult.class);
    JsonArray jsonArray = new JsonArray();
    jsonArray.add(value);
  ...
  public void test_updateStreamingSubscription_with_binding_failure(
      VertxTestContext vertxTestContext) {
    Future<JsonObject> jsonObjectFuture1 = mock(Future.class);
    AsyncResult<JsonObject> asyncResult2 = mock(AsyncResult.class);
  ...
  public void test_UpdateCallbackSubscription_with_failed_permissionHandler(
      VertxTestContext vertxTestContext) {
    ...
    service
        ...
        .onComplete(
            handler -> {
              if (handler.failed()) {
                assertEquals(
                    "{\"error\":\"user Permission failed\"}", handler.cause().getMessage());
                vertxTestContext.completeNow();
  ...
  public void test_UpdateCallbackSubscription_with_failed_resultHandlerbind(
      VertxTestContext vertxTestContext) {
  ...
  public void test_UpdateCallbackSubscription_with_failed_createQueue(
      VertxTestContext vertxTestContext) {
    ...
    service
        ...
        .onComplete(
            handler -> {
              if (handler.failed()) {
                assertEquals(
                    "{\"type\":500,\"title\":\"error\",\"detail\":\"Creation of Queue failed\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
  ...
  public void test_UpdateCallbackSubscription_with_failed_deleteQueueHandler(
      VertxTestContext vertxTestContext) {
    ...
    service
        ...
        .onComplete(
            handler -> {
              if (handler.failed()) {
                assertEquals(
                    "{\"type\":500,\"title\":\"error\",\"detail\":\"Deletion of Queue failed\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
  ...
  public void test_registerStreamingSubscription_empty_routingKey(
      VertxTestContext vertxTestContext) {
    JsonArray jsonArray = new JsonArray();
    jsonArray.add("");
    jsonArray.add("EFGH/EFGH/EFGH/EFGH/EFGH/");
    ...
    service
        ...
        .onComplete(
            handler -> {
              if (handler.failed()) {
                assertEquals(
                    "{\"type\":400,\"title\":\"Bad Request data\",\"detail\":\"Invalid or null"
                        + " routing key\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
  ...
  public void test_appendStreamingSubscription_with_binding_failure(
      VertxTestContext vertxTestContext) {
    Future<JsonObject> jsonObjectFuture1 = mock(Future.class);
    AsyncResult<JsonObject> asyncResult2 = mock(AsyncResult.class);
    String expected =
        "{\"type\":400,\"title\":\"urn:dx:rs:badRequest\",\"detail\":\"Binding failed\"}";
    JsonObject request1 = new JsonObject();
    request1.put(TITLE, FAILURE);
  ...
  public void test_appendStreamingSubscription_with_updateUserPermissions_failure(
      VertxTestContext vertxTestContext) {
  ...
  public void test_appendStreamingSubscription_with_resultHandlerbind_failure(
      VertxTestContext vertxTestContext) {
  ...
  public void test_appendStreamingSubscription_with_null_routingKey(
      VertxTestContext vertxTestContext) {
  ...
  public void test_deleteStreamingSubscription_for_resultHandler_failure(
      VertxTestContext vertxTestContext) {
    when(rabbitClient.deleteQueue(any(), anyString())).thenReturn(jsonObjectFuture);
    doAnswer(
            new Answer<AsyncResult<JsonObject>>() {
  ...
  public void test_listStreamingSubscriptions_for_resultHandler_failure(
      VertxTestContext vertxTestContext) {
    when(rabbitClient.listQueueSubscribers(any(), anyString())).thenReturn(jsonObjectFuture);
    doAnswer(
            new Answer<AsyncResult<JsonObject>>() {
        ...
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                ...
                assertEquals(
                    "{\"type\":400,\"title\":\"error\",\"detail\":\"Listing of Queue failed\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
              }
            });
  ...
  public void test_registerCallbackSubscription_with_empty_request(
      VertxTestContext vertxTestContext) {
    JsonArray jsonArray = new JsonArray();
    jsonArray.add("");
    jsonArray.add("EFGH/EFGH/EFGH/EFGH/EFGH/");
        ...
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                ...
                assertEquals(
                    "{\"type\":500,\"title\":\"error\",\"detail\":\"Invalid or null routing key\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
              }
            });
  ...
  public void test_registerCallbackSubscription_resulthandler_failure(
      VertxTestContext vertxTestContext) {
    JsonArray jsonArray = new JsonArray();
    jsonArray.add("ABCD/ABCD/ABCD/ABCD/ABCD/");
    jsonArray.add("EFGH/EFGH/EFGH/EFGH/EFGH/");
    ...
    service
        ...
        .onComplete(
            handler -> {
              if (handler.failed()) {
                assertEquals(
                    "{\"type\":500,\"title\":\"error\",\"detail\":\"Message publishing failed\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
  ...
  public void test_registerCallbackSubscription_with_null_routingKey(
      VertxTestContext vertxTestContext) {
    JsonArray jsonArray = new JsonArray();
    jsonArray.add(null);
    jsonArray.add("EFGH/EFGH/EFGH/EFGH/EFGH/");
  ...
  public void test_registerCallbackSubscription_executeAsync_failure(
      VertxTestContext vertxTestContext) {
    Future<JsonObject> jsonObjectFuture1 = mock(Future.class);
    AsyncResult<JsonObject> asyncResult2 = mock(AsyncResult.class);
  ...
  public void test_updateCallbackSubscription_with_null_routingKey(
      VertxTestContext vertxTestContext) {
  ...
  public void test_updateCallbackSubscription_resultHandler_failure(
      VertxTestContext vertxTestContext) {
  ...
  public void test_updateCallbackSubscription_executeAsync_failure(
      VertxTestContext vertxTestContext) {
  ...
  public void test_updateCallbackSubscription_failed_resultHandlerbind(
      VertxTestContext vertxTestContext) {
        ...
        .onComplete(
            handler -> {
              if (handler.succeeded()) {
                ...
                assertEquals(
                    "{\"type\":500,\"title\":\"error\",\"detail\":\"failure\"}",
                    handler.cause().getMessage());
                vertxTestContext.completeNow();
              }
            });
  ...
  public void test_deleteCallbackSubscription_publish_message_failure(
      VertxTestContext vertxTestContext) {
    when(voidAsyncResult.succeeded()).thenReturn(false);
    when(rabbitClient.getRabbitMQClient()).thenReturn(rabbitMQClient);
    when(asyncResult.result()).thenReturn(rowSet);
  ...
  public void test_listCallbackSubscription_publish_invalid_requestpayload(
      VertxTestContext vertxTestContext) {
    when(asyncResult.result()).thenReturn(rowSet);
    when(asyncResult.succeeded()).thenReturn(true);
    when(pgSQLClient.executeAsync(anyString())).thenReturn(rowSetFuture);
    ...
    service
        .listCallbackSubscription(request)
        .onComplete(
            handler -> {
              if (handler.failed()) {
                assertEquals(
